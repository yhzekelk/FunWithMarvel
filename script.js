...
let movieListDetailed = [
  ...
  <h2>${movieListDetailed[i]['description']}</h2>
  <h3>This movie was released number ${movieListDetailed[i]['timelinePosition']} in the marvel universee timeline.</h3>
  <h3>The rotten tomatoes rating was ${movieListDetailed[i]['rottenTomatoes']}.</h3>
  `
...
let movieIronMan = {
    ...
    <p>The rotten tomatoes rating was ${movieIronMan['rottenTomatoes']}.
    `
console.log (ironMan)
